...
<div id="header">
    ...
    <nav class="menu-bar">
        ...
        <div class="menu product-menu">
            <a id="product" href="html/product_all_user.html">SẢN PHẨM</a>
            <div class="submenu">
        ...
        <a class="menu" id=" " href="html/purchasing_policy_user.html" >CHÍNH SÁCH MUA HÀNG</a>
        <a class="menu" id="introduce" href="html/introduce_user.html" >GIỚI THIỆU</a>
        <a class="menu" id="contact" href="html/contact_user.html">LIÊN HỆ</a>
...
<div class="footer">
    <div class="footer-container">
        ...
        <div class="footer-col">
            <h3>Chính sách</h3>
            <a href="html/introduce_user.html">Về tụi mình</a>
            <a href="html/purchasing_policy_user.html">Chính sách Thanh toán</a>
            <a href="html/purchasing_policy_user.html">Chính sách Giao hàng</a>
            <a href="html/purchasing_policy_user.html">Chính sách Đổi trả</a>
        </div>


        <div class="footer-col">
            <h3>Hỗ trợ khách hàng</h3>
            <a href="html/product_all_user.html">Tất cả sản phẩm</a>
        </div>
        ...
        <div class="footer-col">
            ...
            <a href="html/purchasing_policy_user.html">Chính sách mua hàng</a>
            <a href="html/introduce_user.html">Giới thiệu</a>
            <a href="html/contact_user.html">Liên hệ</a>
        </div>
    </div>
</div>
